...
諸事情により親から譲ってもらうことになった。早速 Nix を入れた。タイル型WMはMacに合わなくて入れはしたけどやめた。LinuxとMacを気分で使い分けている。

なんだかんだMacが必須(Windowsないので)な場面は Adobe Substance 3D Painter くらい、要は3Dモデリングのときだけで、あとは Linux 必須の開発をするかどうかで決めている。手広く技術をやっているとLinux必須な場面が結構あるんですよ。
